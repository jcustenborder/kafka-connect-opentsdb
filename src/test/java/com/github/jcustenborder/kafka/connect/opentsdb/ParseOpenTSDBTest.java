...
public class ParseOpenTSDBTest {
  ...
  public Stream<DynamicTest> apply() {
    ...
    testcases.put("mysql.bytes_sent 1287333217 6604859181710 schema=foo host=db1",
        new Struct(OpenTSDBParser.SCHEMA)
    ...
    testcases.put("mysql.bytes_received 1287333232 327812421706 schema=foo host=db1",
        new Struct(OpenTSDBParser.SCHEMA)
            .put("metricName", "mysql.bytes_received")
            .put("timestamp", new Date(1287333232L * 1000L))
            .put("value", 327812421706D)
            .put("tags", ImmutableMap.of("schema", "foo", "host", "db1"))
    );
    testcases.put("mysql.bytes_sent 1287333232 6604901075387 schema=foo host=db1",
        new Struct(OpenTSDBParser.SCHEMA)
            .put("metricName", "mysql.bytes_sent")
            .put("timestamp", new Date(1287333232L * 1000L))
    ...
    testcases.put("mysql.bytes_received 1287333321 340899533915 schema=foo host=db2",
        new Struct(OpenTSDBParser.SCHEMA)
            .put("metricName", "mysql.bytes_received")
    ...
    testcases.put("mysql.bytes_sent 1287333321 5506469130707 schema=foo host=db2",
        new Struct(OpenTSDBParser.SCHEMA)
            .put("metricName", "mysql.bytes_sent")
            .put("timestamp", new Date(1287333321L * 1000L))
